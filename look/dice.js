...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-8214e423');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-8214e423');}
...
var brandEl=document.querySelector('.rl-brand-8214e423');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
